...
/**
 * Lovecraft Mythos Ontology: JSON-LD implementation.
 * 
 * Detta program genererar en ontologi baserad på H.P. Lovecrafts mytologi
 * i JSON-LD-format, som speglar Turtle-implementeringen.
 */
public class LovecraftOntologyJsonLD {
    ...
    public static void main(String[] args) {
        System.out.println("Creating Lovecraft Mythos Ontology in JSON-LD format (Java)...");
        ...
        // Spara till JSON-LD-filer
        saveModelAsJsonLD(model, "lovecraft_mythos.jsonld");
        saveModelAsJsonLD(model, "lovecraft_mythos_simple.jsonld");
        
        System.out.println("Done! The ontology has been generated in JSON-LD format.");
    }

    /**
     * Skapar ontologin med klasser, egenskaper och individer.
     * Samma struktur som Turtle-versionen.
     */
    ...
    /**
     * Sparar modellen till en JSON-LD-fil.
     */
    private static void saveModelAsJsonLD(Model model, String filename) {
        try (FileOutputStream out = new FileOutputStream(filename)) {
            // Använd JSON-LD format
            RDFDataMgr.write(out, model, RDFFormat.JSONLD);
            System.out.println("Ontology saved to " + filename + " in JSON-LD format");
        } catch (IOException e) {
